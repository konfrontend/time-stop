...
- Explanations that genuinely need multiple lines go at the method/class/function level (Javadoc, JSDoc, or a block comment above the declaration), not inline.
