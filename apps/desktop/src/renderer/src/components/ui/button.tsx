...
// The ghost variant's fill and invalid line, shared by every ghost editable element.
const ghostStates =
  'hover:bg-accent hover:text-accent-foreground focus-visible:bg-accent focus-visible:text-accent-foreground data-[state=open]:bg-accent data-[state=open]:text-accent-foreground dark:hover:bg-accent/50 dark:focus-visible:bg-accent/50 dark:data-[state=open]:bg-accent/50 aria-invalid:shadow-[inset_0_-2px_0_var(--destructive)]';
...
export { Button, buttonVariants, ghostStates };
